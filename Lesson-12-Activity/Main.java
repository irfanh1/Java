...
String creditCardType(String cardno){
  if(cardno.substring(0,1).equals("4")){
  return "visa";
  }
  else if(cardno.substring(0,2).equals("34") || cardno.substring(0,2).equals("37")){
    return "American Express";
  }
  else if(cardno.substring(0,2).equals("36")){
   return "Diner Club";
  }
  else if(cardno.substring(0,2).equals("55") || cardno.substring(0,2).equals("55")){
    return "Mastercard";
  }
  else if(cardno.substring(0,4).equals("6011") || cardno.substring(0,2).equals("65")){
    return "Discovery";
  }
  else{
    return "unknown";
